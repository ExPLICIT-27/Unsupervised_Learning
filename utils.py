...
#uncomment for running the code for kmeans, else keep commented
# def load_data():
#     X = np.load("Unsupervised_Learning\data\ex7_X.npy")
#     return X 
...
def show_centroid_colors(centroids):
    ...
    plt.imshow(palette)
def load_data():
    X = np.load("Unsupervised_Learning\data2\X_part1.npy")
    X_val = np.load("Unsupervised_Learning\data2\X_val_part1.npy")
    y_val = np.load("Unsupervised_Learning\data2\y_val_part1.npy")
    return X, X_val, y_val

def load_data_multi():
    X = np.load("Unsupervised_Learning\data2\X_part2.npy")
    X_val = np.load("Unsupervised_Learning\data2\X_val_part2.npy")
    y_val = np.load("Unsupervised_Learning\data2\y_val_part2.npy")
    return X, X_val, y_val
